...
export const WalletPaymentModal = ({
    ...
    const handleInitiateRealPhonePePayment = async (e) => {
        ...
        try {
            ...
            if (responseData?.success && responseData?.result?.redirectUrl) {
                // Real PhonePe Standard Checkout Gateway URL
                const targetUrl = responseData.result.redirectUrl;
            ...
            const msg =
                ...
                err?.message ||
                "Unable to open PhonePe payment gateway. Please verify your internet or try again.";
            setErrorMsg(msg);
            showToast(msg, "error");
            setIsInitiating(false);
        }
    ...
    return (
        <div className="fixed inset-0 z-[1000] flex items-end sm:items-center justify-center p-0 sm:p-4 bg-slate-950/70 backdrop-blur-xs font-['Outfit',_sans-serif]">
            <motion.div
